...
function checkAnswer() {
    ...
    if(jsonData.length-1 < i){
        ...
        for (let i = 0; i < 10 ; i++){
          ...
          var ValueA= localStorage.getItem(ValueB)
         
          div = document.getElementById("salut")
          var Child = document.createElement("p")
         
          Child.style.color = "red";
          const cNode = document.createTextNode("Nom: " + (ValueB)+ " Score: ")
...
for(let zIndex = 0; zIndex < jsonData.length; zIndex++)
   {
